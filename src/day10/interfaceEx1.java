...
interface RemoteController{
	//public final이 생략되어있다.
	int num = 10;
	public int chUp(int ch);//추상메소드.
	 ...
	 * 디폴트 메서드는 구현된 내용이 없는 메소드로 추상 메소드와의 차이는 추상메소드는
	 * 구현클래스에서 꼭 오버라이딩을 해야하지만 디폴트는 안해도 된다.
	 */
	public default void test() {}
}
class TvRemoteController implements RemoteController{//구현클래스를 만들어서 구현한다.
